...
const weatherSearch = function({latitude, longitude }) {
  ...
  fetch(`https://api.openweathermap.org/data/2.5/weather?lat=${latitude}&lon=${longitude}&appid=7bffbbdfa44c35e385c794f781cbee17`).then((res) => {
    return res.json();
  }).then((json) => {
  ...
  // then, catch 파트 인강때 onecall을 2.5/weather로 바꾸기!!
